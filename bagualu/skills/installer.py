...
class SkillInstaller:
    ...
    def __init__(self, install_dir: Path | None = None):
        self.install_dir = install_dir or Path.home() / ".bagualu" / "skills"
        self.install_dir.mkdir(parents=True, exist_ok=True)
        self._cache_dir = Path.home() / ".bagualu" / "cache" / "skills"
    ...
    async def _scan_skills_directory(
        ...
        """Scan the skills/ directory in a GitHub repo."""
        results: list[InstallResult] = []
    ...
    async def _install_from_opencode_index(
        ...
        """Install skills using OpenCode discovery protocol."""
        base = url.rstrip("/") + "/"
